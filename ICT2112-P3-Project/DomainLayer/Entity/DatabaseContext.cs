...
public partial class DatabaseContext : DbContext
{
    ...
    public virtual DbSet<DischargeRecord> DischargeRecords { get; set; }
    ...
    public virtual DbSet<FollowUpAppointmentRecord> FollowUpAppointmentRecords { get; set; }

    public virtual DbSet<InPatientHistory> InPatientHistories { get; set; }

    public virtual DbSet<MedicationCounselling> MedicationCounsellings { get; set; }
    ...
    public virtual DbSet<PatientCaregiverAssignment> PatientCaregiverAssignments { get; set; }

    public virtual DbSet<PatientMedicalPlan> PatientMedicalPlans { get; set; }

    public virtual DbSet<PatientMedicalRecord> PatientMedicalRecords { get; set; }

    public virtual DbSet<Photo> Photos { get; set; }

    public virtual DbSet<PreDischargeService> PreDischargeServices { get; set; }

    public virtual DbSet<PreDischargeServiceAssignment> PreDischargeServiceAssignments { get; set; }

    public virtual DbSet<PreDischargeServiceLog> PreDischargeServiceLogs { get; set; }

    public virtual DbSet<PreDischargeServiceSchedule> PreDischargeServiceSchedules { get; set; }

    public virtual DbSet<RescheduleRequest> RescheduleRequests { get; set; }

    public virtual DbSet<SafetyChecklist> SafetyChecklists { get; set; }

    public virtual DbSet<SafetyChecklistAssessment> SafetyChecklistAssessments { get; set; }
